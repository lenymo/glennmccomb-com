...
var iconvLite = __webpack_require__(10);
...
var bomHandling = __webpack_require__(11),
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __webpack_require__(12); // Lazy load all encoding definitions.
...
module.exports = {
    ...
    'gb18030': {
        type: '_dbcs',
        table: function() { return __webpack_require__(2).concat(__webpack_require__(3)) },
        gb18030: function() { return __webpack_require__(24) },
        encodeSkipVals: [0x80],
        encodeAdd: {'€': 0xA2E3},
    },
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(4).concat(__webpack_require__(26)) },
